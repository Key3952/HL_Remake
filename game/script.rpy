...
label final_boss:
    ...
    # Теперь итоговый счёт влияет на выбор финала (можно использовать вместо старых условий или в дополнение)
    if final_game_score >= 15:
        jump final_balance
    elif final_game_score >= 10:
        # можно выбрать один из трёх финалов в зависимости от стиля
        ...
        # низкий счёт – всё равно идём к балансу, но с небольшим штрафом
        $ хаос_фактор += 2
        $ порядок_фактор -= 1
        jump final_balance
